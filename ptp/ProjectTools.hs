...
freeVarsFromStruct structExpr = mapVars (\varName -> ExprAt (ExprString varName) structExpr)
...
exprMemSize (TData name _ TransportCustom _) expr = ExprCall (name ++ "_getsize") [ expr ]
