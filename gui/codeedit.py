...
class TransitionCodeEditor(CodeEditor):
    ...
    def __init__(self, project, transition, variables):
        ...
        CodeEditor.__init__(self, project.get_syntax_highlight_key(), declaration, code, end, (line,0), head)
...
class PlaceCodeEditor(CodeEditor):
    ...
    def __init__(self, project, place, place_type):
        self.place = place
        if place.get_code() == "":
            code = "\t\n"
        else:
        ...
        CodeEditor.__init__(self, project.get_syntax_highlight_key(), begin, code, end, (2,0))
